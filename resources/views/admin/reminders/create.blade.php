<div class="modal fade" id="addPengingat">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            <div class="modal-header">
                <h4 class="modal-title">Tambah Pengingat</h4>
                    ...
                    <div class="row">
                            ...
                            <div class="form-group">
                                ...
                                <select type="text" class="form-control" id="document_id" name="document_id"
                                    ...
                                    @foreach ($dokumen as $dok)
                                        <option value="{{ $dok->id }}">{{ $dok->title }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="date" class="form-control" id="remind_at" name="remind_at" required>
                            </div>
                        </div>
                        <div class="col-lg-12">
                            <div class="form-group">
                                <label for="message">Pesan Pengingat<code>*</code></label>
                                <input type="text" class="form-control" placeholder="Masukan pesan pengingat ..."
